...
public class TraitementAchatCarteSotraDaoImpl extends AbstractTraitementDaoImpl<TraitementAchatCarteSotra> implements TraitementAchatCarteSotraDao, Serializable {
	...
	@Override
	public Collection<TraitementAchatCarteSotra> readByAchat(AchatCarteSotra achatCarteSotra) {
		return entityManager.createQuery("SELECT traitement FROM TraitementAchatCarteSotra traitement WHERE traitement.achat = :achat", clazz)
				.setParameter("achat", achatCarteSotra)
				.getResultList();
	}
