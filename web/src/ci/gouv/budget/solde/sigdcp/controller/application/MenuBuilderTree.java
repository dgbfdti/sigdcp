	...
	private void demande(){
		...
		if(roleManager.isAgentEtat() || roleManager.isAgentMission()){
			if( userSessionManager.getIsIvoirien() ){
				...
				menuManager.addMenuItem(block,"menu.formulerdemande.mtt.exp",null, "demande_tt",new Object[]{webConstantResources.getRequestParamCrudType(),webConstantResources.getRequestParamCrudCreate()
