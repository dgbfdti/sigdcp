...
public class UserSessionManager implements Serializable{
	...
	//tab 3
		uiMenuTabPrestationCotationTTIndex=l++;
	//tab 4
		uiMenuTabPrestationCommandeTTIndex=l++;
		//tab 5	
	//if(roleManager.isResponsable())
		uiMenuTabPrestationCotationFoIndex=l++;
	//tab 5
