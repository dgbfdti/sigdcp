...
public interface AbstractDossierDao<DOSSIER extends Dossier> extends TraitableDao<DOSSIER,Long> {
	...
	/**
	 * Ramene le dossier en saisie d'un requerant. Un dossier en saisie est un dossier avec un et un seul statut qui est SAISI
	 * @param agentEtat
	...
	/**
	 * Ramene le dossier en cours de saisie d'un requerant.
	 * @param requerant
	 * @param natureDeplacement
	 * @return
	 */
	DOSSIER readSaisieEncoursByRequerantByNatureDeplacement(Personne requerant,NatureDeplacement natureDeplacement);
